...
class EnrollmentRequestApproval(BaseModel):
    ...
    approved_by: Optional[StrictStr] = Field(default=None, description="The name of the approver.", alias="approvedBy")
    approved_at: Optional[datetime] = Field(default=None, description="The time at which the request was approved.", alias="approvedAt")
