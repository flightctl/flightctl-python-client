...
class UpdateSchedule(BaseModel):
    ...
    """ # noqa: E501
    time_zone: Optional[StrictStr] = Field(default='Local', description="Time zone identifiers follow the IANA format AREA/LOCATION, where AREA represents a continent or ocean, and LOCATION specifies a particular site within that area, for example America/New_York, Europe/Paris. Only unambiguous 3-character time zones are supported (\"GMT\", \"UTC\").", alias="timeZone")
    ...
    start_grace_duration: Annotated[str, Field(strict=True)] = Field(description="The maximum duration allowed for the action to complete. The duration should be specified as a positive integer followed by a time unit. Supported time units are: `s` for seconds, `m` for minutes, `h` for hours.", alias="startGraceDuration")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "at": obj.get("at"),
            "startGraceDuration": obj.get("startGraceDuration")
        })
        return _obj
