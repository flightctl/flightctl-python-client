...
class AuthStaticOrganizationAssignment(BaseModel):
    """
    ...
    organization_name: StrictStr = Field(description="The name of the organization where all users will be assigned.", alias="organizationName")
    __properties: ClassVar[List[str]] = ["type", "organizationName"]
