...
class EnrollmentService(BaseModel):
    ...
    enrollment_ui_endpoint: StrictStr = Field(description="The URL of the UI that the agent uses to print the QR code and link for enrolling the device.", alias="enrollment-ui-endpoint")
