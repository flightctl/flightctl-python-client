...
class DeviceStatus(BaseModel):
    ...
    systemd: Optional[List[SystemdUnitStatus]] = Field(default=None, description="List of systemd unit statuses.")
    applications: List[DeviceApplicationStatus] = Field(description="List of device application statuses.")
    ...
    __properties: ClassVar[List[str]] = ["conditions", "systemInfo", "systemd", "applications", "applicationsSummary", "resources", "integrity", "config", "os", "updated", "summary", "lastSeen", "lifecycle", "dependencySync", "capabilities"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in systemd (list)
        _items = []
        if self.systemd:
            for _item_systemd in self.systemd:
                if _item_systemd:
                    _items.append(_item_systemd.to_dict())
            _dict['systemd'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "systemd": [SystemdUnitStatus.from_dict(_item) for _item in obj["systemd"]] if obj.get("systemd") is not None else None,
            ...
            "capabilities": DeviceCapabilities.from_dict(obj["capabilities"]) if obj.get("capabilities") is not None else None
        })
        return _obj
