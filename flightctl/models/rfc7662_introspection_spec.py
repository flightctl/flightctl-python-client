...
class Rfc7662IntrospectionSpec(BaseModel):
    """
    ...
    url: StrictStr = Field(description="The RFC 7662 token introspection endpoint URL.")
    __properties: ClassVar[List[str]] = ["type", "url"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['rfc7662']):
            raise ValueError("must be one of enum values ('rfc7662')")
        return value
