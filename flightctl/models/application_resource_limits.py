...
class ApplicationResourceLimits(BaseModel):
    """
    Resource limits for the application.
    """ # noqa: E501
    cpu: Optional[StrictStr] = Field(default=None, description="CPU limit in cores. Format restricted based on application type.")
    memory: Optional[StrictStr] = Field(default=None, description="Memory limit with optional unit. Format restricted based on application type.")
