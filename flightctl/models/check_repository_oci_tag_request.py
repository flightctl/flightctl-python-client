...
class CheckRepositoryOciTagRequest(BaseModel):
    """
    Request to check if a specific image tag exists in an OCI registry.
    """ # noqa: E501
    image_name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="The image name/path within the registry (e.g. \"centos-bootc/centos-bootc\"). Combined with the registry host from the Repository resource, this forms the full repository reference (e.g. \"quay.io/centos-bootc/centos-bootc\").", alias="imageName")
    tag: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="The image tag to check for existence (e.g. \"9.5\").")
    __properties: ClassVar[List[str]] = ["imageName", "tag"]
