...
class ApplicationContent(BaseModel):
    ...
    path: StrictStr = Field(description="A relative file path on the system. Note that any existing file will be overwritten.")
    __properties: ClassVar[List[str]] = ["content", "contentEncoding", "path"]
