...
class RenderedDeviceSpec(BaseModel):
    ...
    """ # noqa: E501
    rendered_version: StrictStr = Field(description="Version of the rendered device spec.", alias="renderedVersion")
    update_policy: Optional[DeviceUpdatePolicySpec] = Field(default=None, alias="updatePolicy")
    os: Optional[DeviceOSSpec] = None
    config: Optional[StrictStr] = Field(default=None, description="The configuration to apply, in Ignition format.")
    applications: Optional[List[RenderedApplicationSpec]] = Field(default=None, description="The list of applications to deploy.")
    ...
    decommission: Optional[DeviceDecommission] = None
    __properties: ClassVar[List[str]] = ["renderedVersion", "updatePolicy", "os", "config", "applications", "systemd", "resources", "console", "decommission"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of decommission
        if self.decommission:
            _dict['decommission'] = self.decommission.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "decommission": DeviceDecommission.from_dict(obj["decommission"]) if obj.get("decommission") is not None else None
        })
        return _obj
