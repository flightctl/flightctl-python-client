...
class DisruptionBudget(BaseModel):
    ...
    """ # noqa: E501
    group_by: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, description="List of label keys to perform grouping for the disruption budget.", alias="groupBy")
    min_available: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="The maximum number of unavailable devices allowed during rollout.", alias="minAvailable")
    max_unavailable: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="The minimum number of required available devices during rollout.", alias="maxUnavailable")
