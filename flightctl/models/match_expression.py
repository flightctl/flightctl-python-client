...
class MatchExpression(BaseModel):
    ...
    operator: StrictStr = Field(description="The operation to apply when matching.")
    values: Optional[List[StrictStr]] = Field(default=None, description="The list of values to match.")
