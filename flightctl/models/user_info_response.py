...
class UserInfoResponse(BaseModel):
    ...
    """ # noqa: E501
    sub: Optional[StrictStr] = Field(default=None, description="Subject identifier.")
    preferred_username: Optional[StrictStr] = Field(default=None, description="Preferred username.")
    name: Optional[StrictStr] = Field(default=None, description="Full name.")
    organizations: Optional[List[Organization]] = Field(default=None, description="User organizations.")
    error: Optional[StrictStr] = Field(default=None, description="Error code.")
    __properties: ClassVar[List[str]] = ["sub", "preferred_username", "name", "organizations", "error"]
