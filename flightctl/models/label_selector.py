...
class LabelSelector(BaseModel):
    ...
    """ # noqa: E501
    match_labels: Optional[Dict[str, StrictStr]] = Field(default=None, description="A map of {key,value} pairs.", alias="matchLabels")
    match_expressions: Optional[Annotated[List[MatchExpression], Field(min_length=1)]] = Field(default=None, description="A list of match expressions.", alias="matchExpressions")
