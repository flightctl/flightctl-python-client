...
class DeviceSpecSystemd(BaseModel):
    ...
    """ # noqa: E501
    match_patterns: Optional[List[Annotated[str, Field(strict=True, max_length=256)]]] = Field(default=None, description="A list of match patterns.", alias="matchPatterns")
