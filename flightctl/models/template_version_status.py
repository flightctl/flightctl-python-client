...
class TemplateVersionStatus(BaseModel):
    ...
    updated_at: Optional[datetime] = Field(default=None, description="The time at which the template was last updated.", alias="updatedAt")
    conditions: List[Condition] = Field(description="Current state of the device.")
    __properties: ClassVar[List[str]] = ["updatePolicy", "os", "config", "applications", "systemd", "resources", "consoles", "decommissioning", "updatedAt", "conditions"]
