...
class DeviceApi:
    ...
    def request_console(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to create a console connection to.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name: The name of the Device resource to create a console connection to. (required)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
