...
class RepositoryApi:
    ...
    @validate_call
    def check_repository_oci_image(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Repository resource to use for registry connection.")],
        check_repository_oci_image_request: CheckRepositoryOciImageRequest,
        ...
        :param name: The name of the Repository resource to use for registry connection. (required)
        :type name: str
        :param check_repository_oci_image_request: (required)
        :type check_repository_oci_image_request: CheckRepositoryOciImageRequest
        ...
        _param = self._check_repository_oci_image_serialize(
            name=name,
            check_repository_oci_image_request=check_repository_oci_image_request,
    ...
    @validate_call
    def check_repository_oci_image_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Repository resource to use for registry connection.")],
        check_repository_oci_image_request: CheckRepositoryOciImageRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CheckRepositoryOciResult]:
        """check_repository_oci_image
    ...
    @validate_call
    def check_repository_oci_image_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Repository resource to use for registry connection.")],
        check_repository_oci_image_request: CheckRepositoryOciImageRequest,
        _request_timeout: Union[
    ...
    def _check_repository_oci_image_serialize(
        self,
        name,
        check_repository_oci_image_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if check_repository_oci_image_request is not None:
            _body_params = check_repository_oci_image_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/repositories/{name}/check-oci-image',
    ...
    @validate_call
    def check_repository_oci_tag(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Repository resource to use for registry connection.")],
        check_repository_oci_tag_request: CheckRepositoryOciTagRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name: The name of the Repository resource to use for registry connection. (required)
        :type name: str
        :param check_repository_oci_tag_request: (required)
        :type check_repository_oci_tag_request: CheckRepositoryOciTagRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._check_repository_oci_tag_serialize(
            name=name,
            check_repository_oci_tag_request=check_repository_oci_tag_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def check_repository_oci_tag_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Repository resource to use for registry connection.")],
        check_repository_oci_tag_request: CheckRepositoryOciTagRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def check_repository_oci_tag_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Repository resource to use for registry connection.")],
        check_repository_oci_tag_request: CheckRepositoryOciTagRequest,
        _request_timeout: Union[
    ...
    def _check_repository_oci_tag_serialize(
        self,
        name,
        ...
        # process the form parameters
        # process the body parameter
        if check_repository_oci_tag_request is not None:
            _body_params = check_repository_oci_tag_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/repositories/{name}/check-oci-tag',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
