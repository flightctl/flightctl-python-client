...
class AuthproviderApi:
    ...
    def delete_auth_provider(
        self,
        name: Annotated[StrictStr, Field(description="The name of the AuthProvider resource to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name: The name of the AuthProvider resource to delete. (required)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_auth_provider(
        self,
        name: Annotated[StrictStr, Field(description="The name of the AuthProvider resource to get.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name: The name of the AuthProvider resource to get. (required)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def patch_auth_provider(
        self,
        name: Annotated[StrictStr, Field(description="The name of the AuthProvider resource to patch.")],
        ...
        :param name: The name of the AuthProvider resource to patch. (required)
        :type name: str
    ...
    @validate_call
    def replace_auth_provider(
        self,
        name: Annotated[StrictStr, Field(description="The name of the AuthProvider resource to update.")],
        auth_provider: AuthProvider,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param name: The name of the AuthProvider resource to update. (required)
        :type name: str
        :param auth_provider: (required)
        :type auth_provider: AuthProvider
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._replace_auth_provider_serialize(
            name=name,
            auth_provider=auth_provider,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def replace_auth_provider_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the AuthProvider resource to update.")],
        auth_provider: AuthProvider,
        _request_timeout: Union[
    ...
    @validate_call
    def replace_auth_provider_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the AuthProvider resource to update.")],
        auth_provider: AuthProvider,
        _request_timeout: Union[
    ...
    def _replace_auth_provider_serialize(
        self,
        name,
        auth_provider,
        _request_auth,
