...
class EnrollmentrequestApi:
    ...
    def enrollment_config(
        self,
        name: Annotated[StrictStr, Field(description="The name of approved CertificateSigningRequest.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name: The name of approved CertificateSigningRequest. (required)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
