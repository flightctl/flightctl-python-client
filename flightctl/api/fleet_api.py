...
class FleetApi:
    ...
    @validate_call
    def start_fleet_application(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Fleet resource.")],
        appname: Annotated[StrictStr, Field(description="The name of the application, as defined in the fleet's device template.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name: The name of the Fleet resource. (required)
        :type name: str
        :param appname: The name of the application, as defined in the fleet's device template. (required)
        :type appname: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._start_fleet_application_serialize(
            name=name,
            appname=appname,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def start_fleet_application_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Fleet resource.")],
        appname: Annotated[StrictStr, Field(description="The name of the application, as defined in the fleet's device template.")],
        _request_timeout: Union[
    ...
    @validate_call
    def start_fleet_application_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Fleet resource.")],
        appname: Annotated[StrictStr, Field(description="The name of the application, as defined in the fleet's device template.")],
        _request_timeout: Union[
    ...
    def _start_fleet_application_serialize(
        self,
        name,
        appname,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fleets/{name}/applications/{appname}/actions/start',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def stop_fleet_application(
        ...
        _param = self._stop_fleet_application_serialize(
            name=name,
            appname=appname,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def stop_fleet_application_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Fleet resource.")],
        appname: Annotated[StrictStr, Field(description="The name of the application, as defined in the fleet's device template.")],
        _request_timeout: Union[
    ...
    @validate_call
    def stop_fleet_application_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Fleet resource.")],
        appname: Annotated[StrictStr, Field(description="The name of the application, as defined in the fleet's device template.")],
        _request_timeout: Union[
    ...
    def _stop_fleet_application_serialize(
        self,
        name,
        appname,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fleets/{name}/applications/{appname}/actions/stop',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
