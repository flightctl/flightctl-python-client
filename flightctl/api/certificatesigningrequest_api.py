...
class CertificatesigningrequestApi:
    ...
    def approve_certificate_signing_request(
        self,
        name: Annotated[StrictStr, Field(description="The name of the CertificateSigningRequest resource to approve or deny.")],
        ...
        :param name: The name of the CertificateSigningRequest resource to approve or deny. (required)
        :type name: str
    ...
    def deny_certificate_signing_request(
        self,
        name: Annotated[str, Field(strict=True, description="The name of the CertificateSigningRequest resource to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
