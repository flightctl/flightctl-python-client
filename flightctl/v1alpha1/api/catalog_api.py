...
class CatalogApi:
    ...
    @validate_call
    def get_catalog_item_deployments(
        self,
        catalog: Annotated[StrictStr, Field(description="The name of the Catalog resource.")],
        name: Annotated[StrictStr, Field(description="The name of the CatalogItem resource.")],
        ...
        _param = self._get_catalog_item_deployments_serialize(
            catalog=catalog,
            name=name,
    ...
    @validate_call
    def get_catalog_item_deployments_with_http_info(
        self,
        catalog: Annotated[StrictStr, Field(description="The name of the Catalog resource.")],
        name: Annotated[StrictStr, Field(description="The name of the CatalogItem resource.")],
        var_continue: Annotated[Optional[StrictStr], Field(description="An optional parameter to query more results from the server. The value of the parameter must match the value of the 'continue' field in the previous list response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CatalogItemDeploymentList]:
        """get_catalog_item_deployments
    ...
    @validate_call
    def get_catalog_item_deployments_without_preload_content(
        self,
        catalog: Annotated[StrictStr, Field(description="The name of the Catalog resource.")],
        name: Annotated[StrictStr, Field(description="The name of the CatalogItem resource.")],
        var_continue: Annotated[Optional[StrictStr], Field(description="An optional parameter to query more results from the server. The value of the parameter must match the value of the 'continue' field in the previous list response.")] = None,
    ...
    def _get_catalog_item_deployments_serialize(
        self,
        catalog,
        name,
        var_continue,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/catalogs/{catalog}/items/{name}/deployments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
