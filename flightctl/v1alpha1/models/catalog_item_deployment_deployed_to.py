...
class CatalogItemDeploymentDeployedTo(BaseModel):
    """
    The device or fleet that this deployment pertains to.
    """ # noqa: E501
    resource_kind: Optional[StrictStr] = Field(default=None, description="Either a Device or Fleet.", alias="resourceKind")
    resource_name: Optional[StrictStr] = Field(default=None, description="The name of the device or fleet.", alias="resourceName")
    __properties: ClassVar[List[str]] = ["resourceKind", "resourceName"]
