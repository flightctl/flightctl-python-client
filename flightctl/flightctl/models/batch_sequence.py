...
class BatchSequence(BaseModel):
    ...
    sequence: Optional[Annotated[List[Batch], Field(min_length=1)]] = Field(default=None, description="A list of batch definitions.")
    __properties: ClassVar[List[str]] = ["strategy", "sequence"]
