...
class ImagePromotion(BaseModel):
    ...
    status: Optional[ImagePromotionStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": ImagePromotionSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": ImagePromotionStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
