...
class ImageBuildDestination(BaseModel):
    ...
    """ # noqa: E501
    repository: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The name of the Repository resource of type OCI to push the built image to.")
    image_name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="The name of the output image.", alias="imageName")
    image_tag: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="The tag of the output image.", alias="imageTag")
