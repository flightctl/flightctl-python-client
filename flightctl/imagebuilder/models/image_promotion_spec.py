...
class ImagePromotionSpec(BaseModel):
    """
    Desired state of an ImagePromotion resource.
    """ # noqa: E501
    source: ImagePromotionSource
    target: ImagePromotionTarget
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "source": ImagePromotionSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "target": ImagePromotionTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
