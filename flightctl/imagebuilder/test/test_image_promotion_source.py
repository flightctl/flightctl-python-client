...
class TestImagePromotionSource(unittest.TestCase):
    """ImagePromotionSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImagePromotionSource:
        """Test ImagePromotionSource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImagePromotionSource`
        """
        model = ImagePromotionSource()
        if include_optional:
            return ImagePromotionSource(
                image_build_ref = '0',
                export_formats = [
                    'vmdk'
                    ]
    ...
    def testImagePromotionSource(self):
        """Test ImagePromotionSource"""
