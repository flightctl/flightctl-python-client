...
class TestJwtIntrospectionSpec(unittest.TestCase):
    """JwtIntrospectionSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JwtIntrospectionSpec:
        """Test JwtIntrospectionSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JwtIntrospectionSpec`
        """
        model = JwtIntrospectionSpec()
        if include_optional:
            return JwtIntrospectionSpec(
                type = 'jwt',
                jwks_url = '',
                issuer = '',
                audience = [
    ...
    def testJwtIntrospectionSpec(self):
        """Test JwtIntrospectionSpec"""
