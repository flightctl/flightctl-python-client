...
class TestDependencySyncConfigRefStatus(unittest.TestCase):
    """DependencySyncConfigRefStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DependencySyncConfigRefStatus:
        """Test DependencySyncConfigRefStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DependencySyncConfigRefStatus`
        """
        model = DependencySyncConfigRefStatus()
        if include_optional:
            return DependencySyncConfigRefStatus(
    ...
    def testDependencySyncConfigRefStatus(self):
        """Test DependencySyncConfigRefStatus"""
